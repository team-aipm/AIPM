...
export default async function HomePage() {
  ...
  return (
    <div className='flex h-dvh flex-col'>
      <main className='flex flex-1 flex-col gap-3.5 overflow-y-auto bg-[#F7FAFB] px-5 py-6'>
        ...
        <section className='relative overflow-hidden rounded-[26px] bg-meti-bg p-5'>
          <div className='relative z-10 max-w-[196px]'>
            <p className='mb-1.5 text-[13px] font-bold text-meti'>
              {todayLabel}
            </p>
            ...
            <div className='mt-3.5 flex items-center gap-2'>
              ...
              >
                <div
                  ...
                  style={{
                    width: `${target === 0 ? 0 : (done / target) * 100}%`,
                  }}
                />
              </div>
