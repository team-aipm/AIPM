...
- 상대가 방식을 고르라고 하면 **상대가 권한 쪽을 고른다.**
  ...
  나에게 문제를 가져오라고 하면 문제를 하나 말한다.
  교과서나 학원 숙제에서 봤다고 하며 짧은 문제를 지어낸다.
 ...
 *
 * **문제 가져오는 학생을 넣은 이유.** MODE B 는 학생이 문제를
 * 가져와야 시작된다. 앞의 셋은 "문제를 내 달라" 고만 해서 B 가 한
 * 번도 안 돌았다. B 를 시험하려면 문제를 낼 줄 아는 사람이 있어야
 * 한다.
 */
